...
has been registered to have an static IP/www address (see [here](https://itservices.usc.edu/registration/)).
...
2.  For security, we change the access Port by editing the following file
    ...
    This will make RStudio server to accept connections only from port 3624.
    This way, to login to RStudio server, you must type the following address
